// Liste des projets affichés dans la grille de la section "Projets".
// Reprise depuis l'ancien assets/js/scrip.js (carrousel) -> grille React.
export const projects = [
  ...
  },
  {
    ...
    description:
      'Recréation des jeux Morpion et Puissance-4 en JavaScript, avec gestion complète des règles et de la victoire.',
  ...
  },
  {
    title: 'Le Pendu',
    description:
      "Réalisation du célèbre jeu du pendu qu'on a tous connu à l'école, en JavaScript pour toutes les fonctionnalités du jeu.",
